...
import ru.pingvn.trevalcalc.Adapters.AdapterTreval;
import ru.pingvn.trevalcalc.R;

public class SwipeToDeleteTreval extends ItemTouchHelper.SimpleCallback {
    private AdapterTreval mAdapter;
    private Drawable mIcon;
    private final ColorDrawable mBackground;

//--------------------------------------------------------------------------------------------------

    public SwipeToDeleteTreval(AdapterTreval mTAdapter, Context mContex) {
