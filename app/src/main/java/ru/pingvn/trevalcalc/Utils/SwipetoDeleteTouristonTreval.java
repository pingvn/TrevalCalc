...
import ru.pingvn.trevalcalc.Adapters.AdapterTourist;
import ru.pingvn.trevalcalc.R;

public class SwipetoDeleteTouristonTreval extends ItemTouchHelper.SimpleCallback {
    private AdapterTourist mAdapter;
    private Drawable mIcon;
    private final ColorDrawable mBackground;

//--------------------------------------------------------------------------------------------------

    public SwipetoDeleteTouristonTreval(AdapterTourist mTAdapter, Context mContex) {
