...
import ru.pingvn.trevalcalc.Adapters.AdapterDirectionList;

import ru.pingvn.trevalcalc.R;

public class SwipeToDeleteDirections  extends ItemTouchHelper.SimpleCallback{
    private AdapterDirectionList mAdapter;
    private Drawable mIcon;
    private final ColorDrawable mBackground;

//--------------------------------------------------------------------------------------------------

    public SwipeToDeleteDirections(AdapterDirectionList mTAdapter, Context mContex) {
